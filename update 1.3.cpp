...
void step4(int num1,int num2,int num3,int num4,string* pro,int pronum,double discount,int day,int* sur,int snum,int way,int ctic,int atic,int gday)
{
            ...
            switch (sur[i])
                {
                    ...
                    case 2:
                        ...
                        cout << setw(40) << "Children " << ctic <<" ticket(s): " << ctic <<"x "<<"200"<< setw(21) << ctic*200 <<endl;
                        cout << setw(40) << "Adult " << atic <<" ticket(s): " << atic <<"x "<<"600"<< setw(22) << atic*600 <<endl;
    ...
    {
          cout << "Survice(s)" << setw(70) << "N/A"<<endl;
    }
    if(discount!=0)
    {
        double dis;
    ...
    {
        cout << "Promotion" << setw(71) << "N/A"<<endl;
        cout << "-------------------------------------------------------------------------------------"<<endl;
...
int main()
{
   ...
   while(snum>4||snum<0)
    ...
    double discount=0;
    int pronum=2;
    string pro[pronum]={"0000","1111"},procode;
    cout<<"****************************************************************" << endl;
